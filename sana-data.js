// SanaCheck mock data — plain ES module, no npm deps
export const STAFF = [
...
export const RANGES = {
  ...
  urineDensity: { label: 'Плотность', unit: 'г/мл', min: 1.010, max: 1.025 },
  ...
  },
  {
    ...
    analyses: [
      ...
      { id: 'a2', date: '2026-07-04', type: 'Общий анализ мочи', by: 'Ольга Смирнова',
        urine: { color: 'Тёмно-жёлтый', density: 1.030, protein: 0.3, glucose: 1.2, leukocytes: 9 } },
    ],
    diagnoses: [
